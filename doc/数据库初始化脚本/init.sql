...
DELETE FROM `lge_user_group` WHERE `id` >= 0 AND `group_key`='default_group';

REPLACE INTO `lge_user_group`
...
UPDATE `lge_user_group` SET `id`=0 WHERE `id` >= 0 AND `group_key`='default_group';
