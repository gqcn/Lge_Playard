...
<div class="row" style="margin-bottom:10px;">
    ...
    <div class="input-group col-xs-1" title="内容分类" data-rel="tooltip" >
    ...
    <input type="text" name="key" placeholder="内容标题关键字查询" class="form-control search-query" value="{$_String->escape($_Get->data['key'])}">
...
<table class="table table-striped table-bordered table-hover">
    <thead>
        <tr>
            ...
            <th style="width:80px;">内容ID</th>
            <th>内容标题</th>
            <th style="width:180px;">内容分类</th>
            <th style="width:150px;">内容作者</th>
        ...
        <tr id="{$item['model_id']}">
            ...
            <td class="center">
                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                    <a href="?app=model&act=showEdit&id={$item['model_id']}" class="green" title="修改" data-rel="tooltip">
                        <i class="icon-pencil bigger-130"></i>
                    </a>

                    <a href="javascript:deleteItem({$item['model_id']});" class="red ButtonDelete" title="删除" data-rel="tooltip">
...
{
    var message = "<div class='bigger-110'>确认删除该内容？</div>";
    bootbox.dialog({
        message: message,
        buttons:            
        {
