...
<input type="hidden" name="frag_id" value="{$data['frag_id']}"/>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2 no-padding-right">碎片分类:</label>
        ...
        {else}
        <div style="margin:5px 0 0 0px;">当前没有碎片分类，您可以点这 <a href="?app=frag&act=category" target="_blank">创建分类</a></div>
        {/if}
        </div>
    </div>

    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2 no-padding-right">碎片排序:</label>
        <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2 no-padding-right required">碎片Key:</label>
        <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
                <input value="{$data['key']}" type="text" name="key" placeholder="用于模板方便获取碎片内容" class="col-xs-12 col-sm-12" />
            </div>
        </div>
    </div>
    
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2 no-padding-right required">碎片名称:</label>
        <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
                <input value="{$data['name']}" type="text" name="name" class="col-xs-12 col-sm-12" />
            </div>
        </div>
    </div>

    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2 no-padding-right">碎片内容:</label>
        <div class="col-xs-12 col-sm-9">
