...
<div class="row" style="margin-bottom:10px;">
    ...
    <input type="text" name="key" placeholder="笔记标题关键字查询" class="form-control search-query" value="{$_String->escape($_GET['key'])}">
        ...
        <tr id="{$item['note_id']}">
            ...
            <td class="center">
                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                    <a href="?app={$_GET['app']}&act=showView&id={$item['note_id']}" class="blue" title="查看" data-rel="tooltip">
                        <i class="icon-zoom-in bigger-130"></i>
                    </a>
                    
                    <a href="?app={$_GET['app']}&act=showEdit&id={$item['note_id']}" class="green" title="修改" data-rel="tooltip">
