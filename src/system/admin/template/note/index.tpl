...
<div class="row" style="margin-bottom:10px;">
    ...
    <div class="input-group col-xs-1" title="笔记分类" data-rel="tooltip" >
    ...
    <input type="text" name="key" placeholder="笔记标题关键字查询" class="form-control search-query" value="{$_String->escape($_Get->data['key'])}">
...
<table class="table table-striped table-bordered table-hover">
    <thead>
        <tr>
            ...
            <th style="width:80px;">笔记ID</th>
            <th>笔记标题</th>
            <th style="width:180px;">笔记分类</th>
        ...
        <tr id="{$item['note_id']}">
            ...
            <td class="center">
                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                    <a href="?app={$_Get->data['app']}&act=showView&id={$item['note_id']}" class="blue" title="查看" data-rel="tooltip">
                        <i class="icon-zoom-in bigger-130"></i>
                    </a>
                    
                    <a href="?app={$_Get->data['app']}&act=showEdit&id={$item['note_id']}" class="green" title="修改" data-rel="tooltip">
                        <i class="icon-pencil bigger-130"></i>
                    </a>

                    <a href="javascript:deleteItem({$item['note_id']});" class="red ButtonDelete" title="删除" data-rel="tooltip">
...
{
    var message = "<div class='bigger-110'>确认删除该笔记？</div>";
    bootbox.dialog({
        message: message,
        buttons:            
        {
            ...
            "danger" :
            {
                ...
                "callback": function() {
                    window.location.href='?app=note&act=delete&id=' + id
                }
            }
        }
    });
